...
import { ArrowLeft, Save, Eye, Camera, AlertCircle, Info, Image, DollarSign } from 'lucide-react';
...
export default function AddProductForm2() {
  ...
  // Fetch ImageKit upload auth parameters from backend on mount
  useEffect(() => {
    fetch('http://localhost:6543/api/imagekit/auth')
      .then((res) => res.json())
      .then((data) => setAuthParams(data))
      .catch((err) => {
        console.error('Failed to fetch ImageKit auth params:', err);
        setErrors((prev) => ({ ...prev, images: 'Failed to get upload authorization.' }));
      });
  }, []);
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            {authParams ? (
              ...
              <p>Loading image upload authorization...</p>
            )}
